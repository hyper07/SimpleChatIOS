    ...
    func registerForPushNotifications(_ accountName:String){
        ...
        UNUserNotificationCenter.current().requestAuthorization(options: getNotificationOption()) { (granted, error) in
            ...
            guard granted else {
                ...
                let alertController = UIAlertController (title: "Permission Error", message: "You need to allow for Push Notification in order to use Talk.", preferredStyle: .alert)
