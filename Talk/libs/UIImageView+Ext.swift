...
//
//  Original Created by Tom Bachant on 1/28/17 from https://github.com/bachonk/InitialsImageView
//
...
private func initialsFromString(string: String) -> String {
    ...
    if words.count > 0 {
        ...
        if firstWord.count > 0 {
            ...
            displayString.append( String(firstWord[firstLetterRange]).uppercased() )
        }
        ...
        if words.count >= 2 {
            ...
            if words.count > 1 {
                ...
                displayString.append( String(lastWord[lastLetterRange]).uppercased() )
            }
        }
    }
